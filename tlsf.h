...
extern void offset_free_ex(void *ptr, void *mem_pool, ptrdiff_t offset);
extern void *offset_malloc_ex(size_t size, void *mem_pool, ptrdiff_t offset);
extern size_t tlsf_pool_malloc_size(int num, size_t size);
extern size_t tlsf_pool_create(size_t size, void *ptr);
